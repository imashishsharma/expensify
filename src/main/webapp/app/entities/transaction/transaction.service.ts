...
export class TransactionService {
    ...
    private convertItemFromServer(transaction: Transaction): Transaction {
        ...
        copy.transactionDate = this.dateUtils
            .convertDateTimeFromServer(transaction.transactionDate);
        copy.createdDate = this.dateUtils
            .convertDateTimeFromServer(transaction.createdDate);
        copy.modifiedDate = this.dateUtils
            .convertDateTimeFromServer(transaction.modifiedDate);
        return copy;
    }
    ...
    private convert(transaction: Transaction): Transaction {
        ...
        copy.createdDate = this.dateUtils.toDate(transaction.createdDate);

        copy.modifiedDate = this.dateUtils.toDate(transaction.modifiedDate);
        return copy;
    }
}
